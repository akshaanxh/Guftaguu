...
export const NameScreen = ({ onStart }) => {
    ...
    return (
        <div className="min-h-screen text-white flex flex-col items-center justify-center p-4 sm:p-6 relative z-10 overflow-y-auto py-12">
            ...
            <GlassCard className="w-full max-w-lg p-8 sm:p-10 text-center relative z-10 hover:border-white/15 transition-all duration-500 hover:shadow-[0_20px_40px_rgba(168,85,247,0.08)]">
                ...
                <p className="text-zinc-400 mb-8 text-sm">Choose a display name to begin chatting & playing.</p>
                ...
                >
                    Start Chatting & Playing →
                </GlowButton>
            </GlassCard>

            {/* Community Request Note */}
            <CommunityNote className="mt-8" />
            
            <footer className="mt-8 text-xs text-zinc-500 flex gap-4 items-center bg-white/5 border border-white/10 px-4 py-2 rounded-full backdrop-blur-md">
